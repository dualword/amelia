...
AEventInfoScene::AEventInfoScene(QObject* parent):QGraphicsScene(parent)
{
...
void AEventInfoScene::handleAddTrack()
{
...
void AEventInfoScene::handleCombTracks()
{
    bool ok;
...
void AEventInfoScene::updateEventInfo()
{
    ...
    dataComplete->setHtml("<html>\n"
                          +QString::number(geo->XmlEvt->EventComplete.numTracks)+"<br>"
                          +QString::number(geo->XmlEvt->EventComplete.numNeutralHadrons)+"<br>"
                          +QString::number(geo->XmlEvt->EventComplete.numChargedHadrons)+"<br>"
                          +QString::number(geo->XmlEvt->EventComplete.numPhotons)+"<br>"
                          +QString::number(geo->XmlEvt->EventComplete.numMuons)+"<br>"
                          +QString::number(geo->XmlEvt->EventComplete.numElectrons)+"<br>"
                          +"</html>");

    dataDisplayed->setHtml("<html>\n"
                           +QString::number(geo->XmlEvt->Event.numTracks)+"<br>"
                           +QString::number(geo->XmlEvt->Event.numNeutralHadrons)+"<br>"
                           +QString::number(geo->XmlEvt->Event.numChargedHadrons)+"<br>"
                           +QString::number(geo->XmlEvt->Event.numPhotons)+"<br>"
                           +QString::number(geo->XmlEvt->Event.numMuons)+"<br>"
                           +QString::number(geo->XmlEvt->Event.numElectrons)+"<br>"
                           +"</html>");

    /*
    QGraphicsTextItem* numShowers;
    QGraphicsTextItem* ETMis;
    */

}

void AEventInfoScene::handleViewportChange(int from,int to)
{
    switch (to)
    {
...
void AEventInfoScene::displayMessage(QString text)
{
...
void AEventInfoScene::hideMessage()
{
    message->setVisible(false);
}

void AEventInfoScene::updateTrackInfo ( track* strack )
{
    message->setVisible(false);
...
void AEventInfoScene::removeTrackInfo(track* strack)
{
    if (combo->deleteTrack(strack))
        refresh();
}

void AEventInfoScene::refresh()
{
